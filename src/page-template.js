...
const generateProjects = projectsdArr => {
  return `
...
module.exports = templateData => {
  ...
  // unsued date is put into a new object called header
  ...
  */
  ...
  // Execute the generateAbout() function between the <main> tags in the template literal
  return `
    <!DOCTYPE html> 
    <html lang="en"> 
